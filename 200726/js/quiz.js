...
var questions = [
    ...
    new Question('CS 속성 중 글자의 굵기를 변경하는 속성은?',['font-size','font-style','font-weight','font-variant'],'font-weight')
];
...
function result(){
    ...
    //백분율 점수 계산
    var per = parseInt((quiz.score*100) / quize.questions.length);
...
function checkAnswer(i){
    ...
    btn[i].addEventListener('click',function(){
        ...
        //ekdma answpfh wlsgod alc rufrhk cjfl
